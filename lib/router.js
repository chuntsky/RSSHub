...
// landiy
router.get('/0landiy/mot/yunjiazhishu/:caty', lazyloadRouteHandler('./routes/0landiy/mot/yunjiazhishu'));
router.get('/0landiy/mot/yunjiazhishunh/:caty', lazyloadRouteHandler('./routes/0landiy/mot/yunjiazhishunh'));
router.get('/0landiy/yuexiuedu/yuexiuedu/:caty', lazyloadRouteHandler('./routes/0landiy/yuexiuedu/yuexiuedu'));
